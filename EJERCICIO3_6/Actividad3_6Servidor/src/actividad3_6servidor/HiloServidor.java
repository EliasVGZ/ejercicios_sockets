...
public class HiloServidor extends Thread {
	...
	long tiempoInicio; // variable para almacenar el tiempo de inicio
	String direccionIP = "192.168.4.11";
    ...
    public HiloServidor(Socket s) throws IOException {// CONSTRUCTOR
		...
		tiempoInicio = System.currentTimeMillis(); // registrar el tiempo de inicio
	}
    
    public void run() {// tarea a realizar con el cliente, tarea del hilo
		String cadena = null;

		System.out.println("=> Conectando a la IP " + direccionIP + ", Puerto remoto: " + socket.getPort() + socket.toString());
        try {
	...
	long tiempoFin = System.currentTimeMillis(); // registrar el tiempo de finalización
	long tiempoTotal = tiempoFin - tiempoInicio; // calcular el tiempo total

	System.out.println("Tiempo total de ejecución para " + socket.toString() + ": " + tiempoTotal + " milisegundos");
